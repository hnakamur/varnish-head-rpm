...
%define varnish_git_commit 37d738ea4c04629766e510daf3d440ac621d8156
%define varnish_git_short_commit %(varnish_git_commit=%{varnish_git_commit} && echo ${varnish_git_commit:0:7})

Summary: High-performance HTTP accelerator
Name: varnish
Version: 4.1.0.4.%{varnish_git_short_commit}
...
%changelog
* Mon Dec 28 2015 Hiroaki Nakamura <hnakamur@gmail.com> - 4.1.0.4.37d738e
- Build using the current head commit (37d738e).
